...
由于博主经常使用U盘和手机给电脑传输文件，但大部分软件都有传输流量限制或者传输速度慢的问题，当然也有一些替代品，比如ftp,samba等，但是为了在windows上方便传输，就有了这个小型的文件传输程序
...
gitee上有适用于windows7的程序，有需要的可以下载

[github](https://github.com/WorldDawnAres/FFTUSR)
[gitee](https://gitee.com/dawnlighta/fftusr)
