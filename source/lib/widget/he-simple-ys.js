          ...
          , Ct = {
            ...
            computed: {
                ...
                formatSwitch: function() {
                    return "en" == this.$i18n.locale ? "change" : "zh" == this.$i18n.locale ? "鍒囨崲" : "hk" == this.$i18n.locale ? "鍒囨彌" : void 0
                },
                formatCompany: function() {
                    return "en" == this.$i18n.locale ? "HeWeather" : "zh" == this.$i18n.locale ? "鍜岄澶╂皵" : "hk" == this.$i18n.locale ? "鍜岄ⅷ澶╂埃" : void 0
                },
                ...
                style: function() {
                    var t = "";
                    return "鐧借壊" === this.level ? t = "#888888" : "钃濊壊" === this.level ? t = "#157BFF" : "榛勮壊" === this.level ? t = "#E4C600" : "姗欒壊" === this.level ? t = "#FF9D1E" : "绾㈣壊" === this.level && (t = "#E25538"),
                    {
        ...
        var xt = n("C7Lr")(Ct, kt, !1, function(t) {
          ...
          , $t = {
            ...
            computed: {
                alarmName: function() {
                    var t = "";
                    return this.alarm && this.alarm.txt && (t = "鍙伴" === this.alarm.txt ? this.$t("alarm.typhoon") : "鏆撮洦" === this.alarm.txt ? this.$t("alarm.rainstorm") : "楂樻俯" === this.alarm.txt ? this.$t("alarm.highTemperature") : "澶ч" === this.alarm.txt ? this.$t("alarm.gale") : "绌烘皵閲嶆薄鏌�" === this.alarm.txt ? this.$t("alarm.airPollution") : this.alarm.txt),
                ...
                bg: function() {
                    if (this.alarm && this.alarm.level) {
                        var t = "";
                        return "鐧借壊" === this.alarm.level || "White" === this.alarm.level ? t = "#888888" : "钃濊壊" === this.alarm.level || "Blue" === this.alarm.level ? t = "#157BFF" : "榛勮壊" === this.alarm.level || "Yellow" === this.alarm.level ? t = "#E4C600" : "姗欒壊" === this.alarm.level || "Orange" === this.alarm.level ? t = "#FF9D1E" : "绾㈣壊" !== this.alarm.level && "Red" !== this.alarm.level || (t = "#E25538"),
                        {
                            backgroundColor: t
                        }
                    }
          ...
          , Nt = {
            ...
            computed: {
                ...
                alarmLevel: function() {
                    ...
                    return "鐧借壊" === this.wd.alarm.level || "White" === this.wd.alarm.level ? t = "#DDD" : "钃濊壊" === this.wd.alarm.level || "Blue" === this.wd.alarm.level ? t = "#0074D9" : "榛勮壊" === this.wd.alarm.level || "Yellow" === this.wd.alarm.level ? t = "#FFDC00" : "姗欒壊" === this.wd.alarm.level || "Orange" === this.wd.alarm.level ? t = "#FF851B" : "绾㈣壊" !== this.wd.alarm.level && "Red" !== this.wd.alarm.level || (t = "#FF4136"),
                    t
                },
                fahrenheit: function() {
        ...
        var Rt = {
            ...
            methods: {
                ...
                parseStickerData: function(t) {
                    var e = this;
                    t.now && (e.wd.current = {},
                    e.fahrenheit ? e.wd.current.tmp = 9 * t.now.tmp / 5 + 32 + "鈩�" : e.wd.current.tmp = t.now.tmp + "掳C",
                    e.wd.current.code = t.now.cond_code,
                    e.wd.current.txt = t.now.cond_txt),
                    t.air_now_city && (e.wd.current.aqi = t.air_now_city.aqi,
                    e.wd.current.aqiTxt = t.air_now_city.qlty.replace("姹℃煋", "").replace("姹欐煋", "").replace(" polluted", "").replace(" pollution", ""),
                    ...
                    e.wd.alarm.level = t.alarm[0].level) : e.wd.pluginConfig.demo && ("en" == e.$i18n.locale ? e.wd.alarm.txt = "Rainstorm" : e.wd.alarm.txt = "鏆撮洦",
                ...
                parseViewData: function(t) {
                    ...
                    e.wd.view.current.aqiTxt = t.air_now_city.qlty.replace("姹℃煋", "").replace("姹欐煋", "").replace(" polluted", "").replace(" pollution", ""),
                    ...
                    t.daily_forecast && t.daily_forecast.length > 0)
                        ...
                        0); r < n; r++) {
                            ...
                            o.max = i.tmp_max,
                            o.min = i.tmp_min,
                            e.fahrenheit ? (o.max = o.max + "鈩�",
                            o.min = o.min + "鈩�") : (o.max = o.max + "掳",
                            o.min = o.min + "掳"),
                    ...
                    e.wd.alarm.txt = t.alarm[0].type,
                    e.wd.alarm.level = t.alarm[0].level) : e.wd.pluginConfig.demo && ("en" == e.$i18n.locale ? e.wd.view.alarm.txt = "Rainstorm" : e.wd.view.alarm.txt = "鏆撮洦",
                    ...
                    t.air_forecast && t.air_forecast && t.air_forecast.length > 0) {
                        ...
                        for (var l = 0; l < s; l++) {
                            ...
                            e.wd.view.forecast[l].aqiTxt = c.qlty.replace("姹℃煋", "").replace("姹欐煋", "").replace(" polluted", "").replace(" pollution", "")
                        }
                    }
                },
